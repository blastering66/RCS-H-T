 ...
 */
public class ExpandableListAdapter_Confirmed extends BaseExpandableListAdapter {
    ...
    public ExpandableListAdapter_Confirmed(Context context, List<String> listDataHeader,
