...
public class RecyclerAdapter_History_Confirmed extends RecyclerView.Adapter<RecyclerAdapter_History_Confirmed.ViewHolder> {
    private Activity activity_adapter;
    private Context context_adapter;
    private List<RowData_History> data;
    private SharedPreferences sh;

    public RecyclerAdapter_History_Confirmed(Context context_adapter, List<RowData_History> data) {
